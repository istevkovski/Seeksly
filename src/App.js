      ...
      <div className="app">
        ...
        <div className="search-bar-wrapper">
          <div className="search-bar">
            ...
            <button className="btn-search"><img src="./assets/images/magnifying-glass.svg" alt="magnifying-glass"/></button>
          </div>
        </div>
        ...
        <div className="footer">
          <p className="powered-by">Powered by: Google</p>
          <p className="copyright">© Ivan Stevkovski 2018 All rights reserved.</p>
        </div>
